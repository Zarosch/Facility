...
public enum MessageUtil {
    ...
    ARENA_COMMAND_LIST_LIST("§6Arenen: §a%arenas"),
    ARENA_COMMAND_LIST_EMPTY("§cKeine Arenen gefunden."),
    ARENA_COMMAND_LISTMODES_LIST("§6Spielmodis: §a%modes"),
    ARENA_COMMAND_LISTMODES_EMPTY("§cKeine Spielmodi gefunden."),
    ARENA_COMMAND_LISTSETTINGS_LIST("§6Settings: §a%settings"),
    ARENA_COMMAND_LISTSETTINGS_EMPTY("§cKeine Settings gefunden."),
    ARENA_COMMAND_LISTLOCS_LIST("§6Locations: §a%locs"),
    ARENA_COMMAND_LISTLOCS_EMPTY("§cKeine Locations gefunden."),
